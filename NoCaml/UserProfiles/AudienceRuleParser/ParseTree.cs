...
namespace TinyPG
{
    ...
    public partial class ParseNode
    {
        ...
        internal object Eval(ParseTree tree, params object[] paramlist)
        {
            ...
            switch (Token.Type)
            {
                ...
                case TokenType.MatchOperator:
                    ...
                    break;
                case TokenType.CombineOperator:
                    Value = EvalCombineOperator(tree, paramlist);
                    break;
                case TokenType.SimpleRule:
                    Value = EvalSimpleRule(tree, paramlist);
                    break;
                case TokenType.CompositeRule:
                    Value = EvalCompositeRule(tree, paramlist);
                    break;
                case TokenType.Rule:
        ...
        protected virtual object EvalCombineOperator(ParseTree tree, params object[] paramlist)
        {
            throw new NotImplementedException();
        }

        protected virtual object EvalSimpleRule(ParseTree tree, params object[] paramlist)
        {
            throw new NotImplementedException();
        }

        protected virtual object EvalCompositeRule(ParseTree tree, params object[] paramlist)
        {
            throw new NotImplementedException();
        }
